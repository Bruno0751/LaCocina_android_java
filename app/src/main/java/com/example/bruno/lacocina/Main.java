...
public class Main extends AppCompatActivity implements SearchView.OnQueryTextListener, View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.mnConfig:
                Intent con = new Intent(Main.this, Configuracoes.class);
                startActivity(con);
                break;
            case R.id.mnSobre:
            ...
            case R.id.mnReceitas:
                Intent receitas = new Intent(Main.this, Receitas.class);
    ...
    public void onClick(View view) {
        if (view == favoritos){
            ...
            Intent entrar = new Intent(Main.this, Entrada.class);
